        ...
        while attempts < 300:
            if sub_t == "การคูณ (แบบตั้งหลัก)":
                ...
                if is_square:
                    ...
                    svg = f"""<br><div style="text-align: center; margin: 10px 0;"><svg width="150" height="150"><rect x="25" y="25" width="100" height="100" fill="#e8f4f8" stroke="#2980b9" stroke-width="3"/><line x1="70" y1="20" x2="80" y2="30" stroke="#c0392b" stroke-width="2"/><line x1="70" y1="120" x2="80" y2="130" stroke="#c0392b" stroke-width="2"/><line x1="20" y1="70" x2="30" y2="80" stroke="#c0392b" stroke-width="2"/><line x1="120" y1="

...
def generate_questions_logic(grade, main_t, sub_t, num_q):
    ...
    # ชุดคำศัพท์สุ่มสำหรับโจทย์ปัญหา เพื่อไม่ให้โจทย์ซ้ำซากจำเจ
    items_shopping = [
        "โทรทัศน์", "ตู้เย็น", "เครื่องซักผ้า", "พัดลม", "เตารีด", 
        "หม้อหุงข้าว", "โทรศัพท์มือถือ", "คอมพิวเตอร์", "เครื่องดูดฝุ่น", "แอร์"
    ]
    items_fashion = [
        "รองเท้าผ้าใบ", "กระเป๋าเป้", "เสื้อแจ็คเก็ต", "กางเกงยีนส์", "นาฬิกาข้อมือ"
    ]
    ...
    for _ in range(num_q):
        ...
        while attempts < 300:
            ...
            if actual_sub_t == "การคูณ (แบบตั้งหลัก)":
                ...
                # ปรับโจทย์ให้มีความหลากหลาย สมศักดิ์ศรี ป.6
                ...
                # สุ่มราคาหลักพัน หลักหมื่น ไม่ให้ลงตัวง่ายๆ
                ...
                if scenario == "ลดราคา":
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>ประโยคสัญลักษณ์:</b> ({percent} ÷ 100) × {base_price:,} = {box_html}</span><br><br><span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>คำว่า ลดราคา {percent}% หมายความว่า ถ้าราคาป้าย 100 บาท จะลดราคาให้ {percent} บาท<br>สามารถเขียนเป็นเศษส่วนได้คือ <b>{percent}/100 ของราคาป้าย</b><br>ให้นำ ({percent} ÷ 100) ไปคูณกับราคาป้ายคือ {base_price:,} บาท<br>= ({percent} × {base_price:,}) ÷ 100 <br>= <b>{amount_change:,} บาท</b><br><b>ตอบ: ลูกค้าจะได้รับส่วนลด {amount_change:,} บาท</b></span>"
                elif scenario == "กำไร":
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>ประโยคสัญลักษณ์:</b> ({percent} ÷ 100) × {base_price:,} = {box_html}</span><br><br><span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>คำว่า กำไร {percent}% หมายความว่า ถ้าราคาทุน 100 บาท จะขายได้กำไร {percent} บาท<br>สามารถเขียนเป็นเศษส่วนได้คือ <b>{percent}/100 ของราคาทุน</b><br>ให้นำ ({percent} ÷ 100) ไปคูณกับราคาทุนคือ {base_price:,} บาท<br>= ({percent} × {base_price:,}) ÷ 100 <br>= <b>{amount_change:,} บาท</b><br><b>ตอบ: พ่อค้าได้กำไรทั้งหมด {amount_change:,} บาท</b></span>"
                else: # ขาดทุน
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>ประโยคสัญลักษณ์:</b> ({percent} ÷ 100) × {base_price:,} = {box_html}</span><br><br><span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>คำว่า ขาดทุน {percent}% หมายความว่า ถ้าราคาทุน 100 บาท จะเสียเงินทุนไป {percent} บาท<br>สามารถเขียนเป็นเศษส่วนได้คือ <b>{percent}/100 ของราคาทุน</b><br>ให้นำ ({percent} ÷ 100) ไปคูณกับราคาทุนคือ {base_price:,} บาท<br>= ({percent} × {base_price:,}) ÷ 100 <br>= <b>{amount_change:,} บาท</b><br><b>ตอบ: แม่ค้าขายขาดทุนไป {amount_change:,} บาท</b></span>"
                ...
                # Fallback ป้องกัน Error หากเกิดเหตุการณ์ไม่คาดคิด (ซึ่งผมได้อุดรอยรั่วทั้งหมดแล้ว)
...
if 'ebook_html' in st.session_state:
    st.success(f"✅ สร้างไฟล์สำเร็จ! (โหมดแข่งขันถูกลบออก 100% และแก้ไขโจทย์ปัญหาร้อยละให้สมบูรณ์แล้วครับ!)")
    c1, c2 = st.columns(2)
    with c1:

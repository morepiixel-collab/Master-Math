...
def generate_questions_logic(grade, main_t, sub_t, num_q):
    ...
    for _ in range(num_q):
        ...
        while attempts < 300:
            ...
            # =========================================================
            # โหมดหลักสูตรปกติ (แก้ไขตรวจสอบเงื่อนไขให้ตรงเป๊ะ 100%)
            # =========================================================
            if actual_sub_t == "การคูณ (แบบตั้งหลัก)":
            ...
            elif actual_sub_t in ["หลัก ค่าของเลขโดดในแต่ละหลัก และรูปกระจาย", "หลัก ค่าของเลขโดด และรูปกระจาย", "หลัก ค่าประจำหลัก และรูปกระจาย", "รูปกระจาย"]:
            ...
            elif actual_sub_t == "ค่าประมาณเป็นจำนวนเต็มสิบ เต็มร้อย เต็มพัน" or actual_sub_t == "ค่าประมาณ":
            ...
            elif actual_sub_t in ["การเรียงลำดับจำนวน (น้อยไปมาก)", "การเรียงลำดับจำนวน (มากไปน้อย)", "การเปรียบเทียบและเรียงลำดับ", "การเรียงลำดับจำนวน"]:
            ...
            elif "การเปรียบเทียบจำนวน" in actual_sub_t:
            ...
            elif actual_sub_t == "การบอกชนิดของมุม" or actual_sub_t == "ชนิดของมุม":
            ...
            elif actual_sub_t == "การหาความยาวรอบรูปสี่เหลี่ยมมุมฉาก" or actual_sub_t == "การหาพื้นที่รูปสี่เหลี่ยมมุมฉาก" or actual_sub_t == "ความยาวรอบรูปและพื้นที่":
                s = random.randint(5, 30)
                is_peri = 'รอบรูป' in actual_sub_t if 'รอบรูป' in actual_sub_t else random.choice([True, False])
            ...
            elif actual_sub_t == "การวัดขนาดของมุม (ไม้โปรแทรกเตอร์)" or actual_sub_t == "ไม้โปรแทรกเตอร์":
            ...
            elif actual_sub_t == "การอ่านและเขียนเศษส่วน" or actual_sub_t == "อ่านและเขียนเศษส่วน":
            ...
            elif actual_sub_t == "แปลงเศษเกินเป็นจำนวนคละ" or actual_sub_t == "เศษเกินเป็นจำนวนคละ":
            ...
            elif actual_sub_t == "การบวกลบเศษส่วน (ตัวส่วนเท่ากัน)" or actual_sub_t == "การบวกเศษส่วน" or actual_sub_t == "การลบเศษส่วน" or actual_sub_t == "บวกลบเศษส่วน":
                den = random.randint(5, 15)
                num1 = random.randint(1, den-1)
                num2 = random.randint(1, den-1)
                op = "+" if "บวก" in actual_sub_t else "-"
                if actual_sub_t == "การบวกลบเศษส่วน (ตัวส่วนเท่ากัน)" or actual_sub_t == "บวกลบเศษส่วน":
                    op = random.choice(["+", "-"])
                    
                if op == "-" and num1 < num2: num1, num2 = num2, num1 
                
                # หากเป็น ป.5 ขึ้นไปและหัวข้อคือ บวก/ลบ เศษส่วน (ที่ส่วนอาจจะไม่เท่ากัน)
                if grade == "ป.5" and actual_sub_t in ["การบวกเศษส่วน", "การลบเศษส่วน"]:
                    ...
                    f1_ex = generate_fraction_html(f"{n1} × {m1}", f"{d1} × {m1}")
                    f2_ex = generate_fraction_html(f"{n2} × {m2}", f"{d2} × {m2}")
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>เนื่องจากตัวส่วน (ด้านล่าง) ไม่เท่ากัน เราจึงต้องทำตัวส่วนให้เท่ากันก่อน โดยการหา ค.ร.น. ของ {d1} และ {d2} ซึ่งก็คือ <b>{lcm_d}</b><br>1) แปลงเศษส่วนตัวแรก: {f1_ex} = {f1_new}<br>2) แปลงเศษส่วนตัวหลัง: {f2_ex} = {f2_new}<br>3) เมื่อตัวส่วนเท่ากันแล้ว นำตัวเศษมา{word_op}กัน: {n1*m1} {op} {n2*m2} = <b>{ans_num}</b><br>จะได้คำตอบคือ:</span> <br><br> {s_ans}"
                else:
            ...
            elif actual_sub_t == "การคูณเศษส่วน" or actual_sub_t == "การหารเศษส่วน" or actual_sub_t == "คูณหารเศษส่วน":
                ...
                if actual_sub_t == "คูณหารเศษส่วน": op = random.choice(["×", "÷"])
            ...
            elif actual_sub_t == "การเขียนเศษส่วนในรูปร้อยละ" or actual_sub_t == "ร้อยละเศษส่วน":
            ...
            elif actual_sub_t == "การหาอัตราส่วนที่เท่ากัน" or actual_sub_t == "อัตราส่วนที่เท่ากัน":
                ...
                q = f"ป้ายติดราคาสินค้าไว้ <b>{price:,} บาท</b> ร้านค้าประกาศลดราคาให้ <b>{percent}%</b> นักเรียนจะได้ลดราคากี่บาท?"
                sol = f"<span style='color: #2c3e50;'><b>ประโยคสัญลักษณ์:</b> ({percent} ÷ 100) × {price:,} = {box_html}</span><br><br><span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>คำว่า ลดราคา {percent}% หมายถึง ({percent} ÷ 100) × ราคาป้าย<br>นำ {price:,} ไปคูณ {percent} แล้วหารด้วย 100 (หรือตัดเลขศูนย์ทิ้ง)<br>= ({percent} × {price}) ÷ 100 = <b>{discount:,} บาท</b><br><b>ตอบ: ได้ลดราคา {discount:,} บาท</b></span>"

            elif actual_sub_t == "การหารยาว" or actual_sub_t == "หารยาว":
            ...
            elif actual_sub_t == "การบวกและการลบทศนิยม" or actual_sub_t == "บวกลบทศนิยม":
            ...
            elif actual_sub_t == "การคูณทศนิยม" or actual_sub_t == "คูณทศนิยม":
            ...
            elif actual_sub_t == "การอ่านและการเขียนทศนิยม" or actual_sub_t == "อ่านทศนิยม":
                n = round(random.uniform(0.1, 99.999), random.randint(1, 3))
                q = f"จงเขียน <b>{n}</b> เป็นตัวหนังสือภาษาไทย"
                sol = f"<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>การอ่านทศนิยม ตัวเลขหน้าจุดให้อ่านแบบจำนวนเต็มปกติ แต่ตัวเลขหลังจุดให้อ่านเรียงตัวทีละตัวครับ<br><b>ตอบ: {generate_thai_number_text(str(n))}</b></span>"

            elif actual_sub_t == "การแก้สมการ (บวก/ลบ)" or actual_sub_t == "การแก้สมการ (+/-)":
            ...
            elif actual_sub_t == "การหา ห.ร.ม." or actual_sub_t == "ห.ร.ม.":
            ...
            elif actual_sub_t == "การหา ค.ร.น." or actual_sub_t == "ค.ร.น.":
            ...
            elif actual_sub_t == "การบอกเวลาเป็นนาฬิกาและนาที" or actual_sub_t == "นาฬิกา":
                ...
                sol = f"<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b> <br>1) ดูเข็มสั้น(สีแดง) ชี้เลยเลข {h} มานิดหน่อย แสดงถึงชั่วโมงที่ {h} <br>2) ดูเข็มยาว(สีน้ำเงิน) ชี้ที่ขีดนาทีที่ {m} (สามารถดูตัวเลขวงนอกประกอบได้)<br>3) เนื่องจากโจทย์ระบุว่าเป็นช่วง <b>{day}</b> จึงอ่านเวลาได้เป็น <b>{ans_h:02d} นาฬิกา</b><br><b>ตอบ: {ans_h:02d}.{m:02d} น.</b></span>"

            elif actual_sub_t == "การอ่านน้ำหนักจากเครื่องชั่งสปริง" or actual_sub_t == "เครื่องชั่งสปริง":
                ...
                sol = f"<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>1) สังเกตตัวเลขกิโลกรัมที่เข็มชี้เลยมาแล้ว: {explain}<br>2) นับขีดเล็กๆ ที่เกินมา (จำไว้ว่า 1 ช่องเล็ก = 1 ขีด)<br><b>ตอบ: สินค้ามีน้ำหนัก {ans_text}</b></span>"

            elif actual_sub_t == "การบอกจำนวนเงินทั้งหมด" or actual_sub_t == "จำนวนเงิน":
                ...
                sol = "<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>ให้เราแยกนับเงินแต่ละชนิดก่อน แล้วค่อยนำมาบวกกันครับ<br>"
                if b100 > 0: sol += f"1) แบงก์ 100 บาท มี {b100} ใบ = {b100*100} บาท<br>"
                if b50 > 0: sol += f"2) แบงก์ 50 บาท มี {b50} ใบ = {b50*50} บาท<br>"
                if b20 > 0: sol += f"3) แบงก์ 20 บาท มี {b20} ใบ = {b20*20} บาท<br>"
                if c10 > 0: sol += f"4) เหรียญ 10 บาท มี {c10} เหรียญ = {c10*10} บาท<br>"
                if c5 > 0: sol += f"5) เหรียญ 5 บาท มี {c5} เหรียญ = {c5*5} บาท<br>"
                if c1 > 0: sol += f"6) เหรียญ 1 บาท มี {c1} เหรียญ = {c1*1} บาท<br>"
                sol += f"เมื่อนำมูลค่าทั้งหมดมาบวกกันจะได้เงินรวม: </span> <b>{total:,} บาท</b>"

            elif actual_sub_t == "การอ่านแผนภูมิรูปภาพ" or actual_sub_t == "แผนภูมิรูปภาพ":
                ...
                q = f"จากแผนภูมิ ขายผลไม้ 3 ชนิดรวมกันทั้งหมดกี่ผล? {table_html}"
                sol = f"<span style='color: #2c3e50;'><b>วิธีทำอย่างละเอียด:</b><br>1) ให้นับจำนวนรูปภาพผลไม้ทั้งหมดในตารางรวมกันก่อน<br>พบว่ามีรูปภาพทั้งหมด {sum(counts)} รูปภาพ<br>2) ดูที่ข้อกำหนดด้านล่างตาราง: 1 รูปภาพ แทนผลไม้ {multiplier} ผล<br>3) นำจำนวนรูปภาพไปคูณกับข้อกำหนด:<br>{sum(counts)} × {multiplier} = <b>{sum(counts) * multiplier} ผล</b><br><b>ตอบ: {sum(counts) * multiplier} ผล</b></span>"

            else:
                # Fallback อย่างปลอดภัย (เผื่อเกิดการหลุดเงื่อนไขจริงๆ จะได้ไม่ Error)
...
if 'ebook_html' in st.session_state:
    st.success(f"✅ สร้างไฟล์สำเร็จ! (โหมดแข่งขันถูกลบออกหมด 100% และแก้ไขการออกโจทย์ร้อยละให้ถูกต้องแล้วครับ!)")
    c1, c2 = st.columns(2)
    with c1:

...
def generate_long_division_step_by_step_html(divisor, dividend, is_key=False):
    ...
    equation_html = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; margin-left: 10px; color: #2c3e50;'>ประโยคสัญลักษณ์: {dividend:,} ÷ {divisor} = {box_html}</span>"
    if not is_key:
        div_tds_list = []
    ...
    for _ in range(num_q):
        ...
        while attempts < 300:
            ...
            if actual_sub_t == "การคูณ (แบบตั้งหลัก)":
                ...
                sentence = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; color: #2c3e50; margin-left: 10px;'>ประโยคสัญลักษณ์: {a:,} × {b:,} = {box_html}</span>"
                ...
                q = f"จงหาผลลัพธ์ของ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; color: #2c3e50; margin-left: 10px;'>ประโยคสัญลักษณ์: {dividend} ÷ {a} = {box_html}</span>"
                ...
                if grade == "ป.5":
                    ...
                    q = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; margin-left:10px;'><b style='font-size: 20px; color: #2c3e50; margin-right: 10px;'>ประโยคสัญลักษณ์: </b> {f1} <span style='font-size:30px; margin: 0 10px;'>{op}</span> {f2} <span style='font-size:30px; margin: 0 10px;'>= </span> {box_html}</span>"
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>วิธีทำ:</b> เนื่องจากตัวส่วนเท่ากัน ให้นำตัวเศษมา{op}กันได้เลย</span><br><br><div style='display:flex; align-items:center; margin-bottom: 15px;'>{f1} <span style='margin:0 10px;'>{op}</span> {f2} <span style='margin:0 10px;'>=</span> {s1} <span style='margin:0 10px;'>=</span> {s2}</div>"
                ...
                if op == "×":
                    ...
                    sol = f"<span style='color: #2c3e50;'><b>วิธีทำ:</b> การคูณเศษส่วน ให้นำตัวเศษคูณตัวเศษ และตัวส่วนคูณตัวส่วน</span><br><br><div style='display:flex; align-items:center; margin-bottom: 15px;'>{f1} <span style='margin:0 10px;'>×</span> {f2} <span style='margin:0 10px;'>=</span> {s1} <span style='margin:0 10px;'>=</span> {s2}</div>"
                else:
                ...
                q = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; color: #2c3e50; margin-left: 10px;'>ประโยคสัญลักษณ์: {a:.2f} {op} {b:.2f} = {box_html}</span>"
                ...
                q = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; color: #2c3e50; margin-left: 10px;'>ประโยคสัญลักษณ์: {a:.1f} × {b} = {box_html}</span>"
                ...
                if random.choice([True, False]):
                    q = f"จงหาจำนวนที่แทนใน {box_html} แล้วทำให้ประโยคเป็นจริง : <span style='display:inline-flex; align-items:center; font-size: 24px; color: #3498db; font-weight: bold; margin-left: 10px;'>{a} : {b} = {c} : {box_html}</span>"
                    ...
                    q = f"จงหาจำนวนที่แทนใน {box_html} แล้วทำให้ประโยคเป็นจริง : <span style='display:inline-flex; align-items:center; font-size: 24px; color: #3498db; font-weight: bold; margin-left: 10px;'>{a} : {b} = {box_html} : {d}</span>"
                ...
                q = f"เสื้อราคา {price:,} บาท ร้านค้าลดราคาให้ {percent}% ร้านค้าลดราคาให้กี่บาท?<div style='margin-top: 10px; font-size: 18px; color: #2c3e50;'><b>ประโยคสัญลักษณ์:</b> ...........................................................</div>"
                ...
                if grade == "ป.4":
                    ...
                    if op == "+":
                        ...
                        q = f"จงแก้สมการเพื่อหาค่า x : <span style='font-size: 24px; color: #3498db; margin-left: 15px;'><b>x + {a} = {b}</b></span>"
                    ...
                    if op == "*":
                        ...
                        q = f"จงแก้สมการเพื่อหาค่า x : <span style='font-size: 24px; color: #3498db; margin-left: 15px;'><b>{a}x = {b}</b></span>"
                        ...
                        q = f"จงแก้สมการเพื่อหาค่า x : <span style='display: inline-flex; align-items: center; font-size: 24px; font-weight: bold; margin-left: 15px; color: #3498db;'><div style='text-align: center; margin-right: 10px;'><span style='border-bottom: 2px solid #3498db; padding: 0 5px;'>x</span><br>{a}</div> = {b}</span>"
                    ...
                    if op == "+":
                        ...
                        q = f"จงแก้สมการเพื่อหาค่า x : <span style='font-size: 24px; color: #3498db; margin-left: 15px;'><b>{a}x + {b} = {c}</b></span>"
                ...
                q = f"จงหาผลลัพธ์ <span style='display:inline-flex; align-items:center; font-size: 20px; font-weight: bold; color: #2c3e50; margin-left: 10px;'>ประโยคสัญลักษณ์: {a} + {b} = {box_html}</span>"
...
def create_page(grade, sub_t, questions, is_key=False, q_margin="25px", brand_name=""):
    title = "เฉลยแบบฝึกหัด" if is_key else "แบบฝึกหัดคณิตศาสตร์"
    student_info = ""
    if not is_key:
        student_info = """
        <table style="width: 100%; margin-bottom: 20px; font-size: 18px; border-collapse: collapse;">
            <tr>
    ...
    <style>
        ...
        .q-box {{ margin-bottom: {q_margin}; padding: 10px 15px; page-break-inside: avoid; border-bottom: 1px solid #eee; }}
        .workspace {{ height: 120px; border: 2px dashed #bdc3c7; border-radius: 8px; margin: 15px 0; padding: 10px; color: #95a5a6; font-size: 16px; display: flex; align-items: flex-start; }}
        .ans-line {{ margin-top: 10px; border-bottom: 1px dotted #999; width: 80%; height: 30px; font-weight: bold; font-size: 18px; display: flex; align-items: flex-end; padding-bottom: 5px; }}
...
spacing_level = st.sidebar.select_slider("↕️ ระยะห่างระหว่างข้อ (พื้นที่ทด):", options=["แคบ", "ปานกลาง", "กว้าง"], value="แคบ")
q_margin = {"แคบ": "10px", "ปานกลาง": "20px", "กว้าง": "40px"}[spacing_level]

st.sidebar.markdown("---")
st.sidebar.markdown("### 🎨 ตั้งค่าแบรนด์ & หน้าปก")
brand_name = st.sidebar.text_input("🏷️ ชื่อแบรนด์ / ผู้สอน (Copyright):", value="ครูคณิตศาสตร์")

        ...
        while attempts < 300:
            ...
            if actual_sub_t == "ปริมาตรและความจุ (มิลลิลิตร ลิตร)":
                ...
                if scenario == "legs":
                    ...
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (โจทย์สมการเศษส่วน):</b><br>👉 กำหนดให้เดิมสมชายมีเงินทั้งหมด <b>x</b> บาท<br>👉 ซื้อหนังสือ: x/{d1} บาท, ซื้อขนม: x/{d2} บาท<br><br><b>ขั้นที่ 1: สร้างสมการ</b><br>👉 เงินทั้งหมด - หนังสือ - ขนม = เงินที่เหลือ<br>👉 x - (x/{d1}) - (x/{d2}) = {rem_money:,}<br><br><b>ขั้นที่ 2: แก้สมการโดยหา ค.ร.น.</b><br>👉 ค.ร.น. ของส่วน {d1} และ {d2} คือ <b>{lcm}</b> {lcm_explain}<br><br>👉 นำ ค.ร.น. ({lcm}) คูณกระจายเข้าไปใน <b>ทุกๆ จำนวน</b> ของสมการ:<br><div style='margin: 12px 0;'>👉 <b>({lcm} × x) - {f_norm1} - {f_norm2} = {rem_money:,} × {lcm}</b></div>👉 นำตัวส่วนไปตัดทอนกับ {lcm} ให้กลายเป็นจำนวนเต็ม:<br><div style='margin: 12px 0;'>👉 <b>{lcm}x - {f_canc1} - {f_canc2} = {rem_money * lcm:,}</b></div>👉 จะได้สมการใหม่ที่ไม่มีเศษส่วนกวนใจแล้ว:<br>👉 {lcm}x - {lcm//d1}x - {lcm//d2}x = {rem_money * lcm:,}<br>👉 ({lcm} - {lcm//d1} - {lcm//d2})x = {rem_money * lcm:,}<br>👉 {rem_frac_n}x = {rem_money * lcm:,}<br>👉 x = {rem_money * lcm:,} ÷ {rem_frac_n} = <b>{ans:,}</b><br><br><b>ตอบ: เดิมสมชายมีเงิน {ans:,} บาท</b></span>"

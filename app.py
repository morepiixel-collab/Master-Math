...
curriculum_db = {
    ...
    "ป.6": {
        "ตัวประกอบของจำนวนนับ (Gifted)": [
            "การหา ห.ร.ม.", 
            "การหา ค.ร.น.", 
            "โจทย์ปัญหา ห.ร.ม. และ ค.ร.น. (ขั้นสูง)",
            "กฎการหารลงตัว (Divisibility Rules)"
        ],
        "เศษส่วนและทศนิยม (Gifted)": [
            "การบวกลบคูณหารระคน",
            "โจทย์ปัญหาเศษส่วนซ้อน (สอบเข้า ม.1)", 
            "อนุกรมเศษส่วน (Telescoping Sum)"
        ],
        "อัตราส่วนและร้อยละ (Gifted)": [
            "โจทย์ปัญหาอัตราส่วนและสัดส่วน", 
            "โจทย์ปัญหาร้อยละ (กำไร-ขาดทุน ซับซ้อน)",
            "โจทย์ปัญหาของผสม (ความเข้มข้น)"
        ],
        "สมการและแบบรูป (Gifted)": [
            "การแก้สมการ (สองขั้นตอน)", 
            "โจทย์ปัญหาสมการ (อายุ/เหรียญ/ขา)", 
            "ลำดับและอนุกรม (Number Patterns)"
        ],
        "โจทย์ปัญหาคลาสสิก (Gifted)": [
            "ความเร็ว ระยะทาง เวลา (รถไฟ/วิ่งไล่กัน)", 
            "งานและการทำงาน (ช่วยกันทำงาน)",
            "แผนภาพเวนน์-ออยเลอร์ (เซต 2 วง)"
        ],
        "เรขาคณิต (Gifted)": [
            "พื้นที่ส่วนที่แรเงา (วงกลมซ้อนเหลี่ยม)", 
            "เส้นขนานและมุมแย้ง (ขั้นสูง)",
            "มุมภายในและมุมเข็มนาฬิกา"
        ],
        "สถิติและความน่าจะเป็น (Gifted)": [
            "ค่าเฉลี่ยแบบประยุกต์ (เพิ่ม/ลด/อ่านผิด)",
            "การจับมือและการแข่งขัน (Combinatorics)"
        ]
    }
}
    ...
    for _ in range(num_q):
        ...
        while attempts < 300:
            ...
            p6_router = {
                ...
                "การบวกลบคูณหารระคน": "เศษส่วน", 
                "โจทย์ปัญหาของผสม (ความเข้มข้น)": "โจทย์ปัญหาของผสม (ความเข้มข้น)", 
                "การแก้สมการ (สองขั้นตอน)": "สมการ",
                ...
                "ความเร็ว ระยะทาง เวลา (รถไฟ/วิ่งไล่กัน)": "ความเร็ว ระยะทาง เวลา (รถไฟ/วิ่งไล่กัน)", 
            ...
            if actual_sub_t in p6_router:
                ...
                is_challenge = True # บังคับเปิดโหมดชาเลนจ์เสมอสำหรับ ป.6

...
# 🔴 ระบบรีเซ็ตปุ่มดาวน์โหลดเมื่อมีการเปลี่ยนการตั้งค่า
if "current_config" not in st.session_state:
    st.session_state.current_config = f"{selected_grade}_{selected_main}_{selected_sub}_{num_input}"

new_config = f"{selected_grade}_{selected_main}_{selected_sub}_{num_input}"
if st.session_state.current_config != new_config:
    if 'worksheet_html' in st.session_state:
        del st.session_state['worksheet_html']

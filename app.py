...
def create_page(grade, sub_t, questions, is_key=False, q_margin="60px", brand_name=""):
    ...
    <style>
        ...
        .workspace {{ height: 150px; border: 2px dashed #bdc3c7; border-radius: 8px; margin: 20px 0; padding: 10px; color: #95a5a6; font-size: 16px; display: flex; align-items: flex-start; }}
        .ans-line {{ margin-top: 15px; border-bottom: 1px dotted #999; width: 80%; height: 30px; font-weight: bold; font-size: 18px; }}
...
q_margin = {"แคบ": "30px", "ปานกลาง": "60px", "กว้าง": "120px"}[spacing_level]

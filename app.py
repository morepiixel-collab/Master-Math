...
def draw_clock_svg(h_24, m):
    ...
    # วาดสเกลนาทีและตัวเลขรอบขอบนาฬิกา
    for i in range(60):
    ...
    # เส้นประจากปลายเข็มไปขอบสเกล (ตามที่คุณสั่ง)
...
if st.sidebar.button("🚀 สั่งสร้างใบงานเดี๋ยวนี้", type="primary", use_container_width=True):
    with st.spinner("กำลังออกแบบรูปภาพและสร้างเฉลยแบบ Step-by-Step..."):
        ...
        # ⚠️ เรียกใช้ฟังก์ชันด้วยตัวแปรแค่ 4 ตัวให้ตรงกับที่ฟังก์ชันต้องการรับ
...
if 'ebook_html' in st.session_state:
    st.success(f"✅ สร้างไฟล์สำเร็จ! โค้ดฉบับสมบูรณ์ไม่มีแอปพัง ล้างโจทย์เก่าออก 100% พร้อมวาดรูปนาฬิกา/แผนภูมิ/ตาชั่ง ตามที่คุณต้องการเป๊ะๆ แล้วครับ!")
    c1, c2 = st.columns(2)
    with c1:

...
curriculum_db = {
    ...
    "ป.4": {
        ...
        "สมการ": ["การแก้สมการ (บวก/ลบ)", "สมการและตัวไม่ทราบค่าจากชีวิตประจำวัน", "สมการเชิงตรรกะและตาชั่งปริศนา", "โจทย์ปัญหาสมการ: ตาชั่งผลไม้", "โจทย์ปัญหาสมการ: นับหัวและขาสัตว์"]
    },
    "ป.5": {

    ...
    for _ in range(num_q):
        ...
        while attempts < 300:
            ...
            if actual_sub_t == "สัญลักษณ์และสมการ":
                ...
                # เปลี่ยนจาก bullet point ให้เป็นความเรียงเชื่อมต่อกัน เพื่อฝึกให้เด็กอ่านและจับใจความโจทย์ปัญหา
                q = f"ปัจจุบันครอบครัวหนึ่งมีพี่น้อง 3 คน คือ เอ บี และซี ถ้าเอมีอายุ <b>{age_a}</b> ปี บีมีอายุมากกว่าเอ <b>{diff_b}</b> ปี และซีมีอายุน้อยกว่าบี <b>{diff_c}</b> ปี จงหาว่าอีก <b>{future}</b> ปีข้างหน้า อายุของทั้งสามคนรวมกันจะเป็นกี่ปี?"

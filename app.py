...
curriculum_db = {
    ...
    "ป.5": {
        ...
        "เตรียมสอบเข้า ม.1 (Gifted)": ["โจทย์ปัญหา ห.ร.ม. และ ค.ร.น."]
    },
    "ป.6": {
        ...
        while attempts < 300:
            ...
            if actual_sub_t == "ปริมาตรและความจุ (มิลลิลิตร ลิตร)":
                ...
                scenario = random.choice([
                    "gcd_fruit", "gcd_student", "gcd_wire", "gcd_tile", 
                    "lcm_clock", "lcm_bus", "lcm_run", "lcm_bell"
                ])
                
                # --- พจนานุกรมอธิบายวิธีหา ค.ร.น. แบบหารสั้น ---
                lcm_explain = {
                    (10, 15, 20): "👉 นำ 5 มาหาร (ได้ 2, 3, 4)<br>👉 นำ 2 มาหาร 2 กับ 4 (ได้ 1, 3, 2)<br>👉 นำตัวหารและผลลัพธ์มาคูณกัน: 5 × 2 × 1 × 3 × 2 = <b>60</b>",
                    (12, 15, 20): "👉 นำ 3 มาหาร 12 กับ 15 (ได้ 4, 5, 20)<br>👉 นำ 5 มาหาร 5 กับ 20 (ได้ 4, 1, 4)<br>👉 นำ 4 มาหาร 4 กับ 4 (ได้ 1, 1, 1)<br>👉 ค.ร.น. = 3 × 5 × 4 = <b>60</b>",
                    (15, 20, 30): "👉 นำ 5 มาหาร (ได้ 3, 4, 6)<br>👉 นำ 3 มาหาร 3 กับ 6 (ได้ 1, 4, 2)<br>👉 นำ 2 มาหาร 4 กับ 2 (ได้ 1, 2, 1)<br>👉 ค.ร.น. = 5 × 3 × 2 × 2 = <b>60</b>",
                    (20, 30, 40): "👉 นำ 10 มาหาร (ได้ 2, 3, 4)<br>👉 นำ 2 มาหาร 2 กับ 4 (ได้ 1, 3, 2)<br>👉 ค.ร.น. = 10 × 2 × 1 × 3 × 2 = <b>120</b>",
                    (15, 30, 45): "👉 นำ 15 มาหาร (ได้ 1, 2, 3)<br>👉 ค.ร.น. = 15 × 1 × 2 × 3 = <b>90</b>",
                    (20, 30, 45): "👉 นำ 5 มาหาร (ได้ 4, 6, 9)<br>👉 นำ 3 มาหาร 6 กับ 9 (ได้ 4, 2, 3)<br>👉 นำ 2 มาหาร 4 กับ 2 (ได้ 2, 1, 3)<br>👉 ค.ร.น. = 5 × 3 × 2 × 2 × 3 = <b>180</b>",
                    (30, 45, 60): "👉 นำ 15 มาหาร (ได้ 2, 3, 4)<br>👉 นำ 2 มาหาร 2 กับ 4 (ได้ 1, 3, 2)<br>👉 ค.ร.น. = 15 × 2 × 1 × 3 × 2 = <b>180</b>"
                }
                ...
                if scenario == "gcd_fruit":
                    ...
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (ประยุกต์ ห.ร.ม.):</b><br>👉 คีย์เวิร์ด: 'แบ่งเท่าๆ กัน' และ 'มากที่สุด' = หา <b>ห.ร.ม.</b> ของ {a}, {b}, {c}<br><br><b>ขั้นที่ 1: หา ห.ร.ม. ด้วยการหารสั้น</b><br>👉 นำ <b>{g}</b> มาหาร {a}, {b} และ {c} จะได้ผลลัพธ์เป็น {m1}, {m2}, {m3} ตามลำดับ<br>👉 เนื่องจาก {m1}, {m2}, {m3} ไม่มีตัวหารร่วมแล้ว ห.ร.ม. จึงเท่ากับ <b>{g}</b><br><i>(ความหมาย: จัดผลไม้ได้มากที่สุดถุงละ <b>{g} ผล</b>)</i><br><br><b>ขั้นที่ 2: หาจำนวนถุงทั้งหมด</b> (นำผลลัพธ์จากการหารมารวมกัน)<br>👉 ส้ม: {m1} ถุง, มังคุด: {m2} ถุง, ชมพู่: {m3} ถุง<br>👉 นำจำนวนถุงมารวมกัน: {m1} + {m2} + {m3} = <b>{m1+m2+m3} ถุง</b><br><b>ตอบ: ถุงละ {g} ผล, ได้ทั้งหมด {m1+m2+m3} ถุง</b></span>"
                    ...
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (ประยุกต์ ห.ร.ม.):</b><br>👉 คีย์เวิร์ด: 'แบ่งกลุ่มเท่าๆ กัน' และ 'มากที่สุด' = หา <b>ห.ร.ม.</b> ของ {a}, {b}, {c}<br><br><b>ขั้นที่ 1: หา ห.ร.ม. ด้วยการหารสั้น</b><br>👉 นำ <b>{g}</b> มาหาร {a}, {b} และ {c} จะได้ผลลัพธ์เป็น {m1}, {m2}, {m3} ตามลำดับ<br>👉 เนื่องจาก {m1}, {m2}, {m3} ไม่มีตัวหารร่วมแล้ว ห.ร.ม. จึงเท่ากับ <b>{g}</b><br><i>(ความหมาย: แบ่งนักเรียนได้กลุ่มละมากที่สุด <b>{g} คน</b>)</i><br><br><b>ขั้นที่ 2: หาจำนวนกลุ่มทั้งหมด</b> (นำผลลัพธ์จากการหารมารวมกัน)<br>👉 ป.4: {m1} กลุ่ม, ป.5: {m2} กลุ่ม, ป.6: {m3} กลุ่ม<br>👉 รวมทั้งหมด: {m1} + {m2} + {m3} = <b>{m1+m2+m3} กลุ่ม</b><br><b>ตอบ: กลุ่มละ {g} คน, ได้ทั้งหมด {m1+m2+m3} กลุ่ม</b></span>"
                    ...
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (ประยุกต์ ห.ร.ม.):</b><br>👉 คีย์เวิร์ด: 'ตัดให้เท่าๆ กัน' และ 'ยาวมากที่สุด' = หา <b>ห.ร.ม.</b> ของ {a}, {b}, {c}<br><br><b>ขั้นที่ 1: หา ห.ร.ม. ด้วยการหารสั้น</b><br>👉 นำ <b>{g}</b> มาหาร {a}, {b} และ {c} จะได้ผลลัพธ์เป็น {m1}, {m2}, {m3}<br>👉 เนื่องจาก {m1}, {m2}, {m3} ไม่มีตัวหารร่วมแล้ว ห.ร.ม. จึงเท่ากับ <b>{g}</b><br><i>(ความหมาย: ตัดลวดได้ยาวที่สุดเส้นละ <b>{g} เมตร</b>)</i><br><br><b>ขั้นที่ 2: หาจำนวนเส้นลวดทั้งหมด</b> (นำผลลัพธ์จากการหารมารวมกัน)<br>👉 เส้นที่ 1 ได้ {m1} เส้น, เส้นที่ 2 ได้ {m2} เส้น, เส้นที่ 3 ได้ {m3} เส้น<br>👉 รวมทั้งหมด: {m1} + {m2} + {m3} = <b>{m1+m2+m3} เส้น</b><br><b>ตอบ: ตัดยาวเส้นละ {g} เมตร, ได้ทั้งหมด {m1+m2+m3} เส้น</b></span>"
                    ...
                    w = g * m1
                    h = g * m2
                    q = f"ห้องโถงรูปสี่เหลี่ยมผืนผ้า กว้าง <b>{w} เซนติเมตร</b> ยาว <b>{h} เซนติเมตร</b><br>ต้องการปูกระเบื้องรูป<b>สี่เหลี่ยมจัตุรัส</b>ที่มีขนาด<b>ใหญ่ที่สุด</b>ให้เต็มห้องพอดีโดยไม่ต้องตัดกระเบื้อง<br>กระเบื้องแต่ละแผ่นจะมีความยาวด้านละกี่เซนติเมตร และต้องใช้กระเบื้องทั้งหมดกี่แผ่น?"
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (ประยุกต์ ห.ร.ม. ขั้นสูง):</b><br>👉 คีย์เวิร์ด: ปูกระเบื้อง 'จัตุรัส' (ด้านเท่ากัน) ที่ 'ใหญ่ที่สุด' = หา <b>ห.ร.ม.</b> ของกว้างและยาว ({w}, {h})<br><br><b>ขั้นที่ 1: หา ห.ร.ม. ด้วยการหารสั้น</b><br>👉 นำ <b>{g}</b> มาหาร {w} และ {h} จะได้ผลลัพธ์เป็น {m1} และ {m2}<br>👉 เนื่องจาก {m1} และ {m2} ไม่มีตัวหารร่วม ห.ร.ม. จึงเท่ากับ <b>{g}</b><br><i>(ความหมาย: กระเบื้องจัตุรัสต้องกว้างและยาวด้านละ <b>{g} เซนติเมตร</b>)</i><br><br><b>ขั้นที่ 2: หาจำนวนแผ่นกระเบื้อง</b><br>👉 <i>ข้อควรระวัง: การหาพื้นที่ต้องนำผลลัพธ์มา 'คูณกัน' ไม่ใช่บวกกัน!</i><br>👉 ด้านกว้างปูได้ {m1} แผ่น, ด้านยาวปูได้ {m2} แผ่น<br>👉 จำนวนแผ่นทั้งหมด = {m1} × {m2} = <b>{m1*m2} แผ่น</b><br><b>ตอบ: ยาวด้านละ {g} เซนติเมตร, ใช้ทั้งหมด {m1*m2} แผ่น</b></span>"

                # ================= หมวด ค.ร.น. =================
                elif scenario in ["lcm_clock", "lcm_bus", "lcm_run", "lcm_bell"]:
                    sets = [(10, 15, 20), (12, 15, 20), (15, 20, 30), (20, 30, 40), (15, 30, 45), (20, 30, 45), (30, 45, 60)]
                    t_tuple = random.choice(sets)
                    t1, t2, t3 = t_tuple
                    
                    lcm = t_tuple[2] * (60 // t_tuple[2]) if t_tuple[2] in [20, 30, 60] else 180 # simplified logic, but using exact math below
                    if t_tuple == (10, 15, 20): lcm = 60
                    elif t_tuple == (12, 15, 20): lcm = 60
                    elif t_tuple == (15, 20, 30): lcm = 60
                    elif t_tuple == (20, 30, 40): lcm = 120
                    elif t_tuple == (15, 30, 45): lcm = 90
                    elif t_tuple == (20, 30, 45): lcm = 180
                    elif t_tuple == (30, 45, 60): lcm = 180
                    ...
                    sol = f"<span style='color:#2c3e50;'><b>วิธีทำอย่างละเอียด (ประยุกต์ ค.ร.น.):</b><br>👉 คีย์เวิร์ด: 'พร้อมกันอีกครั้ง' = หา <b>ค.ร.น.</b> ของ{obj_name} ({t1}, {t2}, {t3})<br><br><b>ขั้นที่ 1: หา ค.ร.น. ด้วยการหารสั้น</b><br>{step_text}<br><br><b>ขั้นที่ 2: แปลงเวลาและบวกเพิ่ม</b><br>👉 เวลาที่ต้องรอคือ {lcm} นาที แปลงเป็น <b>{add_h} ชั่วโมง {add_m} นาที</b><br>👉 เริ่มต้นเวลา {start_h:02d}:{start_m:02d} น. นับบวกเพิ่มไปอีก {add_h} ชม. {add_m} นาที<br>👉 จะได้เป็นเวลา <b>{end_h:02d}:{end_m:02d} น.</b><br><b>ตอบ: {end_h:02d}:{end_m:02d} น.</b></span>"
